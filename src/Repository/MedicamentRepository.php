...
class MedicamentRepository extends ServiceEntityRepository
{
     ...
     * @return Medicament[]
     */
    public function findByPharmacyName(string $Name): array
    {
        return $this->createQueryBuilder('m')
            ->innerJoin('m.pharmacies', 'p')
    ...
    public function findMedicament($searchTerm)
    {
        return $this->createQueryBuilder('c')
            ->where('c.Nom LIKE :searchTerm OR c.Prix LIKE :searchTerm ')
...
//        ;
//    }
     //   public function getMedicamentBypharmacie(int $idph) {
      //      dump($idph);
       //     die;
        //  return $this->createQueryBuilder('m')
       // ->innerJoin('m.id_pharmacie','p')
        //->where('ph.Id = :id')
        //->setParameter('id',$idph)
        //->getQuery()
        //->getResult();
